...
def main():
    ...
    result=run(['docker','compose','exec','-T','mongodb','mongosh','varejomix_events','--quiet'],
               (ROOT/'nosql/03-consultas_funil.js').read_bytes())
    (out/'mongo_local.txt').write_text(result,encoding='utf-8')
